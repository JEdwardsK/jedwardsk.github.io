    ...
    <>
      <div className="homescreen-container">
        ...
        >
          ...
          <Toast.Body styles={{ color: '#6c757d' }}>Hi! Click the Nintendo Switch icon <img src={switchIcon} alt=" nintendo switch icon" style={{ width: '36px' }} /> at the bottom left of the screen for some info on site navigation!</Toast.Body>
        </Toast>
